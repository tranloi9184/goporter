...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">@lang('models/dashboards.header.advanced_search')</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
...
<section class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    {!! Form::open(['route' => 'dashboard.advanced_search']) !!}
                    <div class="card-body">
                        <div class="form-row">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    {!! Form::text('EquipBkDate', $detailstbl['EquipBkDate'], ['class' => 'form-control datepicker']) !!}
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-sm-6">
