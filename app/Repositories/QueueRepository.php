...
class QueueRepository
{
    ...
    {
        $queueInfo = [];
        $queueInfo['user_count'] =  $this->userRepository->count();
        $queueInfo['role_count'] =  $this->roleRepository->count();
        $queueInfo['permission_count'] =  $this->permissionRepository->count();
        $queueInfo['user_online'] =  $this->attendanceRepository->CountUserOnline();
        return $queueInfo;
    }
    private function getChartUserCheckinInfo()
    {
        ...
        $dataset1['data'] = [];
        $dataset1['bqueueColor'] = 'rgb(75, 192, 192)';
        ...
        $dataset2['data'] = [];
        $dataset2['bqueueColor'] = 'rgb(20, 150, 192)';
    ...
    {
        $queue = [];
        $queue['queueInfo'] = $this->getQueueInfo();
        $queue['chartUserCheckin'] = $this->getChartUserCheckinInfo();
        return $queue;
    }
}
