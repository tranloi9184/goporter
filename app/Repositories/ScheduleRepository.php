...
class ScheduleRepository
{
    ...
    {
        $scheduleInfo = [];
        $scheduleInfo['user_count'] =  $this->userRepository->count();
        $scheduleInfo['role_count'] =  $this->roleRepository->count();
        $scheduleInfo['permission_count'] =  $this->permissionRepository->count();
        $scheduleInfo['user_online'] =  $this->attendanceRepository->CountUserOnline();
        return $scheduleInfo;
    }
    private function getChartUserCheckinInfo()
    {
        ...
        $dataset1['data'] = [];
        $dataset1['bscheduleColor'] = 'rgb(75, 192, 192)';
        ...
        $dataset2['data'] = [];
        $dataset2['bscheduleColor'] = 'rgb(20, 150, 192)';
    ...
    {
        $schedule = [];
        $schedule['scheduleInfo'] = $this->getScheduleInfo();
        $schedule['chartUserCheckin'] = $this->getChartUserCheckinInfo();
        return $schedule;
    }
}
